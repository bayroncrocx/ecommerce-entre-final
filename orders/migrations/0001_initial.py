# Generated by Django 4.0.5 on 2022-11-21 17:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orden_note', models.CharField(blank=True, max_length=100)),
                ('orden_total', models.FloatField()),
                ('tax', models.FloatField()),
                ('status', models.CharField(choices=[('New', 'New'), ('Accepted', 'Aceptado'), ('Completed', 'Completado'), ('Cancelled', 'Cancelado')], default='New', max_length=50)),
